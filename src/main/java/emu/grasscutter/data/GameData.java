...
public class GameData {
    ...
    public static int getAreaIdByWorldAreaId2(int areaID2) {
        WorldAreaData worldAreaData = worldAreaDataMap.get(areaID2);
        if (worldAreaData == null) {
            return 1100;
        }
        try {
            return worldAreaData.getID();
        } catch (Exception e) {
            return 0;
        }
    }

    public static int getWeatherAreaIdByAreaId(int areaID) {
        WeatherData weatherData = weatherDataMap.get(areaID);
        if (weatherData == null) {
            return 1;
        }
        try {
            return weatherData.getWeatherAreaID();
        } catch (Exception e) {
            return 0;
        }
    }
